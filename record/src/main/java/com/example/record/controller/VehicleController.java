...
import com.example.record.service.VehicleService;
...
public class VehicleController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<VehicleDto> getIdVehicle(@PathVariable Long id)	{
		VehicleDto VehicleDto = vehicleService.getVehicleId(id);
		if (VehicleDto == null) {
	...
	@PutMapping("/{id}")
	public ResponseEntity<VehicleDto> updateVehicle(@PathVariable Long id, @RequestBody @Valid VehicleDto VehicleDto) {
		try {
	...
	public ResponseEntity<String> deleteVehicle(@PathVariable Long id) {
		 try {
		        ...
		        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("Erro ao deletar o Veículo.");
		    }
	}
}
